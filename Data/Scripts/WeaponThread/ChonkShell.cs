...
{ // Don't edit above this line
    ...
    {
        private AmmoDef ChonkShell => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "ChonkShell",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.00000000001f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 5000000f,
            Mass = 100f, // in kilograms
            Health = 5000, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 500f,
            DecayPerShot = 0f,
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                {
                    Radius = 70f, // the sphere of influence of area effects
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 54000, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                AccelPerSec = 0f,
                DesiredSpeed = 1000,
                MaxTrajectory = 250000f,
